...
const skillPackFinalizer = "k8sclaw.io/skillpack-finalizer"
...
// +kubebuilder:rbac:groups=k8sclaw.io,resources=skillpacks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=k8sclaw.io,resources=skillpacks/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=k8sclaw.io,resources=skillpacks/finalizers,verbs=update
...
func (r *SkillPackReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	skillPack := &k8sclawv1alpha1.SkillPack{}
...
func (r *SkillPackReconciler) reconcileDelete(ctx context.Context, log logr.Logger, skillPack *k8sclawv1alpha1.SkillPack) (ctrl.Result, error) {
...
func (r *SkillPackReconciler) reconcileConfigMap(ctx context.Context, log logr.Logger, skillPack *k8sclawv1alpha1.SkillPack) error {
	...
	cm := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				"k8sclaw.io/component": "skillpack",
				"k8sclaw.io/skillpack": skillPack.Name,
			},
		},
		Data: data,
	}
