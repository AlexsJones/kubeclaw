...
type ClawPolicyStatus struct {
	// BoundInstances is the number of ClawInstances bound to this policy.
	// +optional
...
// and tool access for bound ClawInstances.
type ClawPolicy struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ClawPolicySpec   `json:"spec,omitempty"`
	Status ClawPolicyStatus `json:"status,omitempty"`
}
